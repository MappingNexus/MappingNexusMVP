...
const TeamDashboard: React.FC = () => {
 ...
 if (error && !overview) {
 return (
 <div className="bg-card/50 border border-border p-10 text-center">
 ...
 <div className="bg-card/90 border border-border p-6 w-full max-w-md shadow-2xl">
 ...
 <div key={i} className="border border-border p-5 bg-card backdrop-blur-md">
 ...
 <div key={`${gap.projectName}-${gap.skillName}`} className="border border-border p-4 bg-card backdrop-blur-md">
 ...
 <div key={e.id} className="p-4 border border-border bg-card backdrop-blur-md">
