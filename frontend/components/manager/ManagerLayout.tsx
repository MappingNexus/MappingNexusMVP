...
import { Activity, LayoutDashboard, LogOut, Target, Users, Zap, Settings, Moon, Sun } from 'lucide-react';
...
const ManagerLayout: React.FC<Props> = ({ user, onLogout }) => {
 ...
 <span className="text-muted-foreground text-[11px] font-mono tracking-wide uppercase">MANAGER</span>
 </div>
 </div>
