...
const TeamManage: React.FC = () => {
 ...
 <div key={request.requestId} className="border border-border bg-card p-4">
...
function RequestMemberModal({ onClose, onCreated }: { onClose: () => void; onCreated: () => void | Promise<void> }) {
 ...
 <div className="max-h-[90vh] w-full max-w-2xl overflow-y-auto border border-border bg-card backdrop-blur-md">
 ...
 <div key={index} className="grid grid-cols-1 gap-3 border border-border bg-card p-3 md:grid-cols-[1.8fr,1fr,0.6fr,auto]">
