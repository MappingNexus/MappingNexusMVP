          ...
          {showSearch && (
            <>
              ...
              <Button
                variant="ghost"
                size="icon"
                className="md:hidden h-9 w-9 rounded-full hover:bg-muted/50"
              >
        ...
        <div className="flex items-center gap-1 sm:gap-2 ml-auto">
          ...
          <Link to={notificationsLink}>
            <Button
              variant="ghost"
              size="icon"
              className="h-9 w-9 relative rounded-full hover:bg-muted/50"
            >
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end" className="w-56 rounded-xl shadow-lg">
              ...
              <DropdownMenuItem
                onClick={onLogout}
                className="cursor-pointer text-destructive rounded-lg focus:bg-destructive focus:text-destructive-foreground mt-1"
              >
                Logout
              </DropdownMenuItem>
            </DropdownMenuContent>
